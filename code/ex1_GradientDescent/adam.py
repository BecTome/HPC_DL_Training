...
N_EPOCHS = 1000
ls_lr = [0.00001, 0.00005, 0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5]
MOMENTUM = 0.9
...
plt.legend()
plt.title(f"AdamOptimizer with different LR")
plt.xlabel("Epochs")
plt.ylabel("Loss")

filename = f"AdamOptimizer_{np.min(ls_lr)}-{np.max(ls_lr)}".replace(".", "_") + ".pdf"
